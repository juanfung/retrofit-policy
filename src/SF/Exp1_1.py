...
url = 'https://raw.githubusercontent.com/juanfung/retrofit-policy/master/data/processed/SF_Exp1/Wood%20frame/pre1980_nonsoft_wood_single.csv'
...
df3.to_csv('Pre1980_woodframe.csv')  # Export data to a csv file 
...
df3.to_csv('Wood_assessment_pre1980.csv')   # Export data to a csv file 
